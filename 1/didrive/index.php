...
// внутренние действия с телефонами
$vv['actions_phone'] = [
    //  Описание: 
   'getSIMList' => [ 
       'name' => '' ,
       'opis' => 'Получение номера SIM-карты/IMSI для BAN.' ,
       'data' => [ 
           'ban' => 'номер бан' , // *
           'cnt' => 'телефон' , //
        ]
   ...
   'getServicesList' => [ 
       'name' => '' ,
       'opis' => 'Получения списка подключенных услуг на уровне BAN/CTN.' ,
       'data' => [ 
           'ban' => 'номер бан' , // *
           'cnt' => 'телефон' , //
        ]
    ] ,
    // Описание: Получения информации об абонентах на уровне BAN/CTN.
   'getCTNInfoList' => [ 
       'name' => 'инфа о владельце' ,
       'data' => [ 
           'ban' => 'номер бан' , // *
           'cnt' => 'телефон' , //
        ]
